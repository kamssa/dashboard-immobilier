...
public class ContenuMailDemande {
private String lien="";
 ...
 private String contenuHtml ="<!DOCTYPE html>\r\n" + 
 		...
 		"						Bonjour, bienvenue au Goupe GstorePlus\r\n" + 
 		"					</span></font>\r\n" + 
 		"				</div>\r\n" + 
 		...
 		"						Merci pour votre demande sur la plateforme. Nos commerciaux vous contacterons pour la suite du processus : <a href='";
 		...
 		"                         \r\n" + 
 		" 							<span style='font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;'>\r\n" + 
 		" 								Vous pouvez suivre en temps réel votre terrain avec Gstoreplus.\r\n" + 
 		" 							</span></font> \r\n" + 
 		" 						</div>\r\n" + 
 		"		</table>		\r\n" + 
 		"	</td></tr>\r\n" + 
 		...
 		"				Localisation : Vallon non loin de ecobank| Email: info@gstoreplus.ci | Tel:(+225) 27 23 59 04 39 | Adresse: 25 BP 1323 ABIDJAN 25<br/>\r\n" + 
...
public ContenuMailDemande() {
	super();
	// TODO Auto-generated constructor stub
}

public ContenuMailDemande(String codeValidation, String contenuHtml) {
	super();
	this.codeValidation = codeValidation;
	this.contenuHtml = contenuHtml;
}

public ContenuMailDemande(String lien, String codeValidation, String contenuHtml, String variable) {
	super();
	this.lien = lien;
	this.codeValidation = codeValidation;
	this.contenuHtml = contenuHtml;
